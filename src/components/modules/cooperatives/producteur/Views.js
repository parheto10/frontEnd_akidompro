                      ...
                      <div className="row align-items-center g-3 text-center text-xxl-start">
                        ...
                        <div className="col-12 col-sm-auto flex-1">
                          <h3 className="fw-bolder mb-2">{producteur.nomComplet}</h3>
                           <u className="mb-0">Lieu : </u><a className="fw-bold" href="#!">{producteur.lieu_habitation}</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="card mb-3">
                    <div className="card-body">
                      <div className="d-flex align-items-center mb-5">
                        <Link className="btn px-3" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} to={`/producteur-recoltes-views/${prodID}/`}> Livraisons</Link>
                      </div>
                      {/*<div className="mb-4">*/}
                      ...
                      <div className="mb-4">
                        <div className="d-flex align-items-center mb-1"><span className="me-2 uil uil-phone"> </span>
                          <h5 className="text-1000 mb-0 text-warning">Contact</h5>
                      ...
                      <div className="mb-4">
                        <div className="d-flex align-items-center mb-1"><span className="me-2 uil uil-globe"></span>
                          <h5 className="text-1000 mb-0 text-warning">Coopérative</h5>
                      ...
                      <div className="mb-4">
                        <div className="d-flex align-items-center mb-1"><span className="me-2 uil uil-building"></span>
                          <h5 className="text-1000 mb-0 text-warning">Section</h5>
                        </div>
                      ...
                      <div className="mb-4">
                        <div className="d-flex align-items-center mb-1"><span className="me-2 uil uil-postcard"></span>
                          <h5 className="text-1000 mb-0 text-warning">Nombre de parcelle</h5>
                        </div>
                      ...
                      <div>
                        <div className="d-flex align-items-center mb-1"><span className="me-2 uil uil-check-circle"></span>
                          <h5 className="text-1000 mb-0 text-warning">statut</h5>
                        </div><span className="badge badge-phoenix badge-phoenix-success">Actif</span>
                      </div>
                    </div>
                  </div>
                {/*   <div className="card mb-3">
                ...
                <nav className="navbar pb-1 px-0 sticky-top bg-soft bg-secondary bg-opacity-10 rounded nav-underline-scrollspy" id="navbar-deals-detail">
                  <ul className="nav nav-underline rounded" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}}>
                   {/*  <li className="nav-item"><a className="nav-link pe-3" href="#scrollspyTask">Task</a></li> */}
                    <li className="nav-item text-white text-center"><a className="nav-link pe-3 text-white text-center" href="#scrollspyDeals">Mes Parcelles</a></li>
                ...
                <div className="scrollspy-example bg-body-tertiary rounded-2" data-bs-spy="scroll" data-bs-offset="0" data-bs-target="#navbar-deals-detail" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
                  ...
                  <div className="mb-8 mt-3">
                    <div className="d-flex justify-content-between align-items-center mb-4" id="scrollspyDeals">
                      ...
                      <button className="btn btn-sm" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} onClick={()=>modalOpenParc()}><span className="fa-solid fa-plus me-2"></span>Ajouter une parcelle</button>
                    </div>
                        ...
                        <table className="table fs--1 mb-0">
                          <thead>
                            <tr className="rounded-3" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}}>
                              ...
                              <th className="sort align-middle pe-6 text-uppercase text-end" scope="col" data-sort="amount" >Producteur</th>
                              <th className="sort align-middle text-start text-uppercase" scope="col" data-sort="stage" >CO2(eq T)</th>
                              <th className="sort align-middle text-start text-uppercase" scope="col" data-sort="probability" >Latitude</th>
                              <th className="sort align-middle ps-0 text-end text-uppercase" scope="col" data-sort="date" >Longitude</th>
                        ...
                        <div className="col-auto d-flex"><button className="page-link" data-list-pagination="prev"><span className="fas fa-chevron-left"></span></button>
                         ...
                         <>
                            {!loadingDetailParc ?
                             ...
                             <h2 className="mb-2 placeholder-glow" >Activités de la parcelle <span style={{"backgroundColor":"#E6CA83"}}>{targetID}</span>{/* <button className="btn btn-primary btn-sm float-end ">Modifier</button> */}</h2>
                              <div class="card-body bg-white p-3 rounded-2 border-top border-300 row">
                                <div class="vstack gap-1 col-md-6">
                                  <div class="bg-light border">Code : <b>{targetID}</b></div>
                                  <div class="bg-light border">Culture: <b>{parc.culture?.libelle}</b></div>
                                  <div class="bg-light border">Latitude: <b>{parc.latitude}</b></div>
                                  <div class="bg-light border">Longitude: <b>{parc.longitude}</b></div>
                                </div>
                                <div class="vstack gap-1 col-md-6">
                                  <div class="bg-light border">Superficie : <b>{parc.superficie} Ha</b></div>
                                  <div class="bg-light border">Mode acquisition : <b>{parc.acquisition?.libelle}</b></div>
                                   <div class="bg-light border">Certification: {parc.certificat?.libelle}</div>
                             ...
                             <div className="border-top border-300">
                               ...
                               {componentActivityName == "planting" &&
                                  <>
                                      <button className="btn btn-sm float-end" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} onClick={modalOpenPlanting}>Faire planting</button>
                                      <div className="search-box row mb-3">
                                        <form className="position-relative " data-bs-toggle="search" data-bs-display="static"><input className="form-control search-input search" type="search" placeholder="Recherche de planting" aria-label="Search" />
                                          <span className="fas fa-search search-box-icon"></span>
                                        </form>
                                      </div>
                                  </>
                             ...
                             <h2 className="mb-2 placeholder-glow " ><span className="placeholder" style={{"backgroundColor":"#FFDB58"}}>En cours de chargement...</span> <button className="btn btn-primary btn-sm float-end placeholder">Modifier</button></h2>
