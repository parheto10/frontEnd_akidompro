                  ...
                  <table className="table fs--1 mb-0">
                        <thead>
                          <tr className="" style={{backgroundColor: "#E6CA83", color: "#fff", fontWeight: "bold"}}>
                            ...
                            <th className="sort white-space-nowrap align-middle  text-uppercase mr-2 text-center" scope="col"  style={{"width":"10%"}}>Date</th>
                            <th className="sort align-middle pe-3 text-uppercase text-center" scope="col"  style={{"width":"15%"}}>Parcelle</th>
                            <th className="sort align-middle pe-3 text-uppercase text-center" scope="col"  style={{"width":"10%"}}>Campagne</th>
                            <th className="sort align-middle  text-uppercase text-center" scope="col"  style={{"width":"10%", "min-width":"50px"}}>Taux de reussite</th>
                            <th className="sort align-middle pe-0 text-uppercase text-center" scope="col" style={{"width":"25%", "min-width":"100px"}}>Plants Vivants/Plantés</th>
                                              ...
                                              <div>
                                                ...
                                                <div className="modal-header px-card border-bottom ">
                                                  <div className="w-100 d-flex justify-content-between align-items-start">
                                                    <div>
                                                      <h5 className="mb-0 lh-sm text-1000">Les details du Monitoring {moni.code} </h5>
                                                    ...
                                                    <div className="row">
                                                      ...
                                                      <table id="emptbl" class="table table-bordered border-primary ">
                                                          <thead class="table-dark ">
                                                              <tr>
                                                                  <th className="text-center" style={{"width":"45%"}}>Especes</th>
                                                                  <th className="text-center" style={{"width":"15%"}}>Plants Vivants</th>
                                                                  <th className="text-center" style={{"width":"15%"}}>Taux/Espèce</th>
