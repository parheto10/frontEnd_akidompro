                                                  ...
                                                  <div  >
                                                    ...
                                                    <div className="modal-header px-card border-bottom">
                                                      <div className="w-100 d-flex justify-content-between align-items-start">
                                                        <div>
                                                          <h5 className="mb-0 lh-sm text-1000">Monitoring du planting {planting.code} </h5>
                                                      ...
                                                      <div class="panel-body">
                                                          <div class="row">
                                                                  ...
                                                                  <div class="col-sm-4 mb-2">
                                                                      <div class="form-group">
                                                                          <label>Date de monitoring</label>
                                                                  ...
                                                                  <div class="col-lg-4">
                                                                    ...
                                                                    <div class="form-group">
                                                                            <label>Causes de mortalité</label>
                                                          ...
                                                          <fieldset>
                                                              <legend class="border-top mb-2 mt-3" style={{"margin-bottom": "0px"}}>
                                                                Liste des espèces reçues et plantés
                                                              </legend>
                                                          <table id="emptbl" class="table table-bordered border-primary ">
                                                              <thead class="table-dark ">
                                                                  <tr>
                                                                      ...
                                                                      <th className="text-center">Plants dénombré</th>
                                                                  </tr>
                                                              </thead>
                                                              <tbody>
                                                                  {
                                                                    ...
                                                                    <td >
                                                                      ...
                                                                      {nbrePlantes[index] > plant.plants && <span className="text-info">Avertissement ! plants denombré supérieur aux plants recus.</span>}
                                                                    </td>
                                                              ...
                                                              <button  class="btn btn-sm btn-success" style={{"float": "right"}} onClick={submitFormMonitoring}>Enregistrer Monitoring</button>
                                        ...
                                        <div class="modal-dialog modal-md" role="document">
                                            <div>
                                              ...
                                              <div className="modal-header px-card border-bottom ">
                                                <div className="w-100 d-flex justify-content-between align-items-start">
                                                  <div>
                                                    <h5 className="mb-0 lh-sm text-1000">Les details du planting {planting.code} </h5>
                                                  </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                                                </div>
                                              </div>
                                                <div class="panel-body">
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div id="form" >
                          ...
                          <div className="modal-header px-card border-bottom">
                            <div className="w-100 d-flex justify-content-between align-items-start">
                              <div>
                                <h5 className="mb-0 lh-sm text-1000">Faire planting sur la parcelle <b>{parc}</b></h5>
                              </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                            </div>
                          </div>
                            <div class="panel-body">
                                <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                          ...
                                          <div class="form-group">
                                                  <label>Plants existant sur la parcelle</label>
                                    ...
                                    <div class="col-lg-12">
                                          ...
                                          <div class="form-group">
                                                    <label>Decrire les plants existants sur la parcelle</label>
                                ...
                                <fieldset>
                                    <legend class="border-top mb-2 mt-3" style={{"margin-bottom": "0px"}}>
                                     ...
                                     <button type="button" class="btn btn-sm btn-info mx-2 float-end mt-2" onClick={errorIdEspece ==""  ? addChampsPlanting: null}>Ajouter</button>
                                     </legend>
                                <table id="emptbl" class="table table-bordered border-primary ">
                                    <thead class="table-dark ">
                                        <tr>
                                    ...
                                    <tbody>
                                     ...
                                     <button  class="btn btn-sm btn-success" style={{"float": "right"}} onClick={submitFormPlanting}>Enregistrer Planting</button>
