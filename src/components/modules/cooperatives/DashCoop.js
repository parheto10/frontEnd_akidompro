...
function DashCoop(){
    ...
    return (
        <Content sideID={"dash-coop"} parent={""}>
          <h2 className="mt-5">Bienvenue | {user?.nom} {user?.prenom} (225) {cooperative.contacts}</h2>
