...
function CarteCoop(){
    ...
    //     // L.control.browserPrint().addTo(window.L.map);
    //         // window.print()
    //     var browserPrint = L.browserPrint(window.L.map);
    //     L.control.browserPrint(browserPrint).addTo(window.L.map);
    // }
            ...
            <div className="navbar-vertical-content" style={{backgroundColor: "#EEF1DE"}}>
                ...
                <a className={activeNav == 'tous' ? "nav-link active" : "nav-link"} href="#" data-bs-toggle="" aria-expanded="false" onClick={()=>fetchDataCoop()}>
                    <div className="d-flex align-items-center">
                        <span className="" style={{fontWeight: "bold", fontSize: 28, marginTop: "20px"}}>TOUS <span className="text-white" style={{backgroundColor: 'red', borderRadius: 15}}>({totalPoint})</span> </span>
                    </div>
                </a>
        ...
        <div className="content" style={{backgroundColor: "#EEF1DE"}}>
            <div style={{marginLeft: "-37px", marginTop: "-35px", marginRight: "-35px"}}>
                ...
                >
                    ...
                    {user && user?.id === 8 ?
                        <LayersControl>
                            ...
                            <LayersControl.Overlay name="Points D'Intérêt">
                                <GeoJSON
                                    style={{"color": "#fff"}}
                                    data={Infra}
                                                                    ...
                                                                    <table className="table fs--1 mb-0">
                                                                        ...
                                                                        <tr className="bg-warning">
                                                                            ...
                                                                            <th className="sort align-middle pe-3 text-uppercase"
                                                                                scope="col"
                                                                                style={{"width": "15%"}}>Parcelle
                                                                            </th>
                                                                            <th className="sort align-middle pe-3 text-uppercase"
                                                                                scope="col"
                                                                                style={{"width": "10%"}}>Especes
                                                                            </th>
                ...
                <div className="mt-2 bg-white p-3 border-2 rounded-5 legend" style={{listStyle: null, marginBottom: "5px", height: "80px",}}>
                    <h4 style={{marginTop: "0px"}}>STATUT FONCIER</h4>
                    ...
                    }}></span> <span style={{fontWeight: "bold", fontSize: "20px"}}><i> Agroforêt</i></span></div>
                    ...
                    }}></span> <span style={{fontWeight: "bold", fontSize: "20px"}}><i> Forêt classée</i></span></div>
                    ...
                    }}></span> <span style={{fontWeight: "bold", fontSize: "20px"}}><i> Parc & réserve</i></span></div>
                </div>
                <div className="legend" style={{listStyle: null, marginTop: "10px", marginLeft: "20px"}}>
                    ...
                    <h4 style={{marginTop: "0px"}}>NIVEAU DE RISQUE</h4>
                    <div style={{float: "left", marginRight: "10px"}}><span className="kindaawesome" style={{
                        border: "1px",
                        solid: "#ccc",
                        float: "left",
                    ...
                    }}></span> <span style={{fontWeight: "bold", fontSize: "20px"}}><i> Données invalides</i></span>
                    </div>
                    <div style={{float: "left", marginRight: "10px"}}><span className="kindaawesome" style={{
                        border: "1px",
                        solid: "#ccc",
                ...
                <div className="bg-white p-3 border-5 rounded-5" style={{marginTop: "-10px", marginBottom: "-50px", height: "120px"}}>
                    <ul style={{marginTop: "0px"}}>
                        <li>Parcelles à Risque Elevé : Ensemble des parcelles qui chevauchent une Forêt classée / Parc
                            &
                            Réserve
                        </li>
                        ...
                        <li>Parcelles à Risque zéro : Ensemble des parcelles situé à plus de 2 Km d'une forêt classée /
                            parc & réserve
                        </li>
                        <li>Données Invalides : Ensemble des parcelles ayant des irrégularités de polygones et de
                            positionnement
                        </li>
                    </ul>
                </div>
