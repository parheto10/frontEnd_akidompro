...
function ListCoop(){
    ...
    return (
        <Fragment>
            ...
            <h2 className="text-bold text-1100 mb-5 mt-5">Coopératives</h2>
            <div id="members" >
                ...
                <div className="col-auto">
                  <div className="d-flex align-items-center">
                      ...
                      <button className="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addEventModal">
                        ...
                        {user?.is_adg ? "Modifier Profil" : "Créer une coopérative"}  
                      </button>
                  </div>
                </div>
              </div>
                  ...
                  <table className="table table-striped table-sm fs--1 mb-0 ">
                    <thead>
                      ...
                      <th className="sort align-middle text-center" scope="col"  style={{width:"5%"}}>Logo</th>
                        <th className="sort align-middle text-center" scope="col"  style={{width:"20%"}}>Coopérative</th>
                        <th className="sort align-middle text-center" scope="col" style={{width:"20%"}}>Région</th>
                        <th className="sort align-middle text-center" scope="col" style={{width:"20%"}}>Siège</th>
                        <th className="sort align-middle text-center pe-3" scope="col"  style={{width:"20%"}}>Projet associé</th>
                        <th className="sort align-middle text-center" scope="col" style={{width:"15%"}}>Responsable</th>
                        <th className="sort align-middle text-center" scope="col" style={{width:"15%"}}>Produceturs</th>
                        <th className="sort align-middle text-center " scope="col" style={{width:"10%",  minWidth:"50px"}}>Action</th>
                      </tr>
                    </thead>
