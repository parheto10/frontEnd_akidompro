...
//console.log(parcelleList);
    return(
        <>
            ...
            <h2 className="text-bold text-1100 mb-5">Liste des Productions ({totalParc})</h2>
                  ...
                  <div className="table-responsive scrollbar ms-n1 ps-1">
                    <table className="table fs--1 mb-0">
                          ...
                          <tr className="" style={{backgroundColor: "#EE9F27", color: "#fff", fontWeight: "bold"}}>
                              ...
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="stage">Superficie</th>  
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="stage">Estimation(Kg)</th> 
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="type">Qte(kg)</th>               
