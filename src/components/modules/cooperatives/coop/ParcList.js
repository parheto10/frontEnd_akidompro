                                              ...
                                              <div id="addEventForm" autoComplete="off">
                                                ...
                                                <div className="row">
                                                  ...
                                                  <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                                                    <button className="btn px-4 form-control" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} type="button" onClick={submitParc}>Modifier</button>
                                                  </div>
                                              </div>
                                            </div>
                                          </div>
