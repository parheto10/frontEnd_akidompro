...
function ProdCoopList(){
  ...
  /* axios.get(baseUrl+'/producteurs-list/?coopID='+coopID).then((resp)=>{
    ...
    <Content sideID={"cooperatives"} parent={"generalite"}>
            <h2 className="text-bold text-1100 mb-5">Liste des producteurs ({totalProd})</h2>
                  ...
                  <div className="col col-auto">
                    <div className="search-box">
                      <div className="position-relative" data-bs-toggle="search" data-bs-display="static">
                          <input className="form-control search-input search" type="search" placeholder="Recherche un producteur" aria-label="Search" onChange={onSearchProd} />
                  ...
                  <div className="table-responsive scrollbar ms-n1 ps-1">
                    <table className="table fs--1 mb-0">
                          ...
                          <tr className="" style={{backgroundColor: "#EE9F27", color: "#fff", fontWeight: "bold"}}>
                              ...
                              <th className="sort align-middle pe-6 text-uppercase text-center" scope="col" data-sort="amount" >Nom et prénoms</th>
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="stage" >Campagne</th>
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="probability" >Nombre Parcelle</th>
                              <th className="sort align-middle ps-0 text-center text-uppercase" scope="col" data-sort="date" >Section</th>
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="type" >Contact</th>
                                              ...
                                              <div id="addEventForm" autoComplete="off">
                                                <div className="modal-header px-card border-0">
                                                  <div className="w-100 d-flex justify-content-between align-items-start">
                                                    <div>
                                                      <h5 className="mb-0 lh-sm text-1000">Enregistrer une parcelle pour <b className="text-success">{prod.nomComplet}</b></h5>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="form-floating mb-5 col-md-6">
                                                       ...
                                                       {/*  {errors.acquisition && <span className="text-danger">{errors.acquisition}</span>} */}
                                                        <label htmlFor="eventLabel" className="pb-2 text-black">Mode d'acquisition de la parcelle</label>
                                                    </div>
                                                    ...
                                                    <div className="form-floating mb-5 col-md-6">
                                                        ...
                                                        <label htmlFor="eventLabel" className="pb-2 text-black">Année d'acquisition</label>
                                                    </div>
                                                </div>
                                                <div className="row">
                                                  ...
                                                  <div className="row">
                                                    ...
                                                    <div className="form-floating mb-3 col-md-6">
                                                      ...
                                                      <label htmlFor="eventTitle" className="pb-2 text-black">Superficie</label>
                                                    </div> 
                                                    ...
                                                    <div className="form-floating mb-3 col-md-6">
                                                        ...
                                                        <label htmlFor="eventLabel" className="pb-2 text-black">Culture sur la parcelle</label>
                                                    </div>
                                                  ...
                                                  <div className="form-floating mb-3">
                                                    ...
                                                    <label htmlFor="eventTitle" className="pb-2 text-black">Latitude</label>
                                                  </div>

                                                
                                                    <div className="form-floating mb-3">
                                                      <input className="form-control" id="chef" type="text" name="longitude" onChange={handleChangeParcelle} value={parcelleData.longitude} />
                                                      <label htmlFor="eventTitle" className="pb-2 text-black">Longitude</label>
                                                    </div>
                                          ...
                                          <div class="modal fade" id={`editProdmodal-${prod.code}`} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div className="modal-dialog modal-md">
                                                    ...
                                                    <div id="addEventForm" autoComplete="off">
                                                        ...
                                                        <div className="w-100 d-flex justify-content-between align-items-start">
                                                            <div>
                                                            <h5 className="mb-0 lh-sm text-1000">Modifier {prod.code}</h5>
                                                            </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                                                        </div>
                                                        </div>
                                                        <div className="modal-body p-card py-0">
                                                        ...
                                                        <div className="row">
                                                          <div className="form-floating mb-3">
                                                              ...
                                                              <label htmlFor="eventTitle" className="pb-2 text-black">Code du producteur</label>
                                                          </div>
                                                            ...
                                                            <div className="form-floating mb-5 col-md-12">
                                                                ...
                                                                <label htmlFor="eventLabel" className="pb-2 text-black">Section</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="form-floating mb-3">
                                                            ...
                                                            <label htmlFor="eventTitle" className="pb-2 text-black">Nom complet</label>
                                                        </div>
                                                        ...
                                                        <div className="form-floating mb-3">
                                                            ...
                                                            <label htmlFor="eventTitle" className="pb-2 text-black">Lieu d'habitation</label>
                                                            </div>
                                                        ...
                                                        <div className="form-floating mb-3 row border-top mt-2">
                                                          ...
                                                          <label htmlFor="eventTitle" className="pb-2 text-black">Modifier ma photo</label>
                                                        ...
                                                        <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                                                            <button className="btn px-4 form-control" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} type="button" onClick={submitProdedit}>Modifier le producteur</button>
                                                        </div>
                                                    </div>
                                                    </div>
                                                </div>
            ...
            <div className="modal fade" id="addEventModalProd" data-bs-backdrop="static" role="dialog" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div className="modal-dialog modal-md">
                    ...
                    <div id="addEventForm" autoComplete="off">
                        ...
                        <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                            <button className="btn px-4 form-control" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} type="button" onClick={submitProd}>Ajouter</button>
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="mb-1">
                     ...
                     <button 
                      ...
                      >
                        {loading ? (
                          <span>
                            <i className="fas fa-spinner fa-spin"></i> Téléchanrgement en cours ...
                          </span>
                        ) : (
                          <span>
                            <i class="fa fa-cloud-download" aria-hidden="true">Exporter</i> Téléchanrgement en cours ...
                          </span>
