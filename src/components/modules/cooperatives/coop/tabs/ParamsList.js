    ...
    return (
        <> 
              <div className="tab-pane fade active show mb-3 " >
                  <div className="row align-items-center gx-4 gy-3 flex-wrap mb-3">
                      <div className="col-auto d-flex flex-1">
                       <h4 className="mb-0">Saisons de recolte ({saisons.length})</h4>
                       <button className="fw-bold fs--1 btn btn-sm py-1 mx-2" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} data-bs-toggle="modal" data-bs-target="#addEventModalSaison">Ajouter une saison</button>
                      </div>
                                                  ...
                                                  <div id="addEventForm" autoComplete="off">
                                                    <div className="modal-header px-card border-0">
                                                      <div className="w-100 d-flex justify-content-between align-items-start">
                                                        <div>
                                                          <h5 className="mb-0 lh-sm text-1000">Modifier <b className="text-success">{saison.libelle}</b></h5>
                                                    ...
                                                    <div className="modal-body p-card py-0">
                                                      ...
                                                      <div className="form-floating mb-3">
                                                        ...
                                                        <label htmlFor="eventTitle" className="pb-2 text-warning">Libelle</label>
                                                      </div>
                                                      
                                                      
                                                      </div>
                                                      <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                                                        <button className="btn btn-success px-4 form-control" type="button" onClick={()=>submitSaisonEdit(saison.id)}>Modifier</button>
                                                      </div>
                                                  </div>
                                                </div>
                                              </div>
              ...
              <div className="tab-pane fade active show" id="notes-tab" role="tabpanel" aria-labelledby="activity-tab">
                  <div className="row align-items-center gx-4 gy-3 flex-wrap mb-3">
                      <div className="col-auto d-flex flex-1">
                       <h4 className="mb-0">Cultures ({cultures.length})</h4>
                       <button className="fw-bold fs--1 btn btn-sm py-1 mx-2" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} data-bs-toggle="modal" data-bs-target="#addEventModalCulture">Ajouter une culture</button>
                      </div>
                    ...
                    <table className="table fs--1 mb-0">
                          <thead>
                            <tr className="" style={{backgroundColor: "#E6CA83"}}>                              
                              <th className="sort white-space-nowrap align-middle  ps-0 text-uppercase text-center" >Libelle</th>
                              <th className="sort white-space-nowrap align-middle  ps-0 text-uppercase text-center" >Prix du kilogramme (Fcfa)</th>
                              <th className="sort align-middle ps-0 text-center text-uppercase" >Action</th>                             
                            </tr>
                          </thead>
                          <tbody className="list" id="lead-details-table-body">
                                                    ...
                                                    <div className="modal-content border">
                                                      <div id="addEventForm" autoComplete="off">
                                                        <div className="modal-header px-card border-0">
                                                          <div className="w-100 d-flex justify-content-between align-items-start">
                                                            <div>
                                                              <h5 className="mb-0 lh-sm text-1000">Modifier <b className="text-success">{culture.libelle}</b></h5>
                                                            </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                                                          </div>
                                                        </div>
                                                        <div className="modal-body p-card py-0">
                                                          ...
                                                          <div className="form-floating mb-3">
                                                            ...
                                                            <label htmlFor="eventTitle" className="pb-2 text-warning">Prix du kilogramme</label>
                                                          </div>
                                                          
                                                          
                                                          </div>
                                                          <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                                                            <button className="btn btn-success px-4 form-control" type="button" onClick={()=>submitCultureEdit(culture.id)}>Modifier </button>
                                                          </div>
                                                      </div>
                                                    </div>
                                                  </div>
              ...
              <div className="tab-pane fade active show mt-3" id="notes-tab" role="tabpanel" aria-labelledby="activity-tab">
                  <div className="row align-items-center gx-4 gy-3 flex-wrap mb-3">
                      <div className="col-auto d-flex flex-1">
                       <h4 className="mb-0 mx-2">Sections ({sectionsList.length})</h4>
                       <button className="fw-bold fs--1 btn btn-sm py-1 float-end" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}} data-bs-toggle="modal" data-bs-target="#addEventModalSection">Ajouter une section</button>
                      </div>
                                                  ...
                                                  <div className="modal-content border">
                                                    <div id="addEventForm" autoComplete="off">
                                                      <div className="modal-header px-card border-0">
                                                        <div className="w-100 d-flex justify-content-between align-items-start">
                                                          <div>
                                                            <h5 className="mb-0 lh-sm text-1000">Modifier <b className="text-primary">{section.libelle}</b></h5>
                                                          </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                                                        </div>
                                                      </div>
                                                      <div className="modal-body p-card py-0">
                                                        ...
                                                        <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                                                          <button className="btn btn-success px-4 form-control" type="button" onClick={()=>submitSectEdit(section.id)}>Modifier</button>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
                    ...
                    <div className="modal-content border">
                      <div id="addEventForm" autoComplete="off">
                        <div className="modal-header px-card border-0">
                          <div className="w-100 d-flex justify-content-between align-items-start">
                            <div>
                              <h5 className="mb-0 lh-sm text-1000">Enregistrement d'une section</h5>
                            </div><button className="btn p-1 fs--2 text-900" type="button" data-bs-dismiss="modal" aria-label="Close">Fermer </button>
                          </div>
                        </div>
                        <div className="modal-body p-card py-0">
                          ...
                          <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                            <button className="btn btn-primary px-4 form-control" type="button" onClick={submitSect}>Ajouter</button>
                          </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="modal-content border">
                      <div id="addEventForm" autoComplete="off">
                        ...
                        <div className="modal-body p-card py-0">
                          ...
                          <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                            <button className="btn btn-primary px-4 form-control" type="button" onClick={submitCulture}>Ajouter</button>
                          </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="modal-content border">
                      <div id="addEventForm" autoComplete="off">
                        ...
                        <div className="modal-body p-card py-0">
                          ...
                          <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                            <button className="btn btn-primary px-4 form-control" type="button" onClick={submitSaison}>Ajouter</button>
                          </div>
                      </div>
                    </div>
                  </div>
